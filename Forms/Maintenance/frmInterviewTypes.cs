    ...
    public partial class frmInterviewTypes : Form
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                {
                    conn.Open();
                    string query = "SELECT interview_type_id AS ID, name AS Name FROM interview_types";
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT INTO interview_types (name) VALUES (@name)";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    string query = "UPDATE interview_types SET name = @name WHERE interview_type_id = @id";
                    var cmd = new MySqlCommand(query, conn);
                    cmd.Parameters.AddWithValue("@name", name);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    string query = "DELETE FROM interview_types WHERE interview_type_id = @id";
                    var cmd = new MySqlCommand(query, conn);
                    cmd.Parameters.AddWithValue("@id", id);
                    cmd.ExecuteNonQuery();
