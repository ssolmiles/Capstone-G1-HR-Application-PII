        ...
        private void LoadData()
        {
            try
            {
                using (var conn = DatabaseHelper.GetConnection())
                {
                    ...
                    string query = "SELECT type_id AS ID, label AS Name FROM employment_types";
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var conn = DatabaseHelper.GetConnection())
                {
                    ...
                    string query = "INSERT INTO employment_types (label) VALUES (@name)";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var conn = DatabaseHelper.GetConnection())
                {
                    ...
                    string query = "UPDATE employment_types SET label = @name WHERE type_id = @id";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var conn = DatabaseHelper.GetConnection())
                {
                    ...
                    string query = "DELETE FROM employment_types WHERE type_id = @id";
